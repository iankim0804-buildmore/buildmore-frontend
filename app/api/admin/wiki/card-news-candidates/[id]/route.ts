...
export async function GET(
  ...
  try {
    const res = await fetch(`${adminApiUrl}/api/admin/wiki/card-news-candidates/${encodeURIComponent(id)}`, {
    ...
    console.error('[admin/api/wiki/card-news-candidates/:id] Error:', error)
