  ...
  return (
    <div className="border-t border-[#e4e4e7] bg-white">
      ...
      <div className="grid grid-cols-3 gap-3 px-5 py-4">
        ...
        <div className="border border-[#e4e4e7] rounded-[12px] p-3 flex flex-col">
          <div className="inline-flex w-fit mb-2">
            <span className="text-[12px] font-medium text-[#666] border border-[#d4d4d8] rounded-full px-2 py-0.5 bg-transparent">무료</span>
          </div>
          <h4 className="text-[14px] font-semibold text-[#09090b] mb-1.5">이 분석 저장하기</h4>
          <p className="text-[12px] text-[#a1a1a6] leading-snug flex-1 mb-3 break-keep">협상 전에 들고 가세요. 지금 분석 결과를 PDF로 저장합니다.</p>
        ...
        <div className="border border-[#e4e4e7] rounded-[12px] p-3 flex flex-col">
          <div className="inline-flex w-fit mb-2">
            <span className="text-[12px] font-medium text-[#666] border border-[#d4d4d8] rounded-full px-2 py-0.5 bg-transparent">유료</span>
          </div>
          <h4 className="text-[14px] font-semibold text-[#09090b] mb-1.5">딜 브리핑 받기</h4>
          <p className="text-[12px] text-[#a1a1a6] leading-snug flex-1 mb-3 break-keep">금융·리스크·밸류 애드 안전 분석, 48시간 내 전달.</p>
        ...
        <div className="border-2 border-[#f59e0b] rounded-[12px] p-3 flex flex-col bg-[#fffbeb]">
          <div className="inline-flex w-fit mb-2">
            <span className="text-[12px] font-medium text-[#b45309] bg-[#fed7aa] rounded-full px-2 py-0.5">★ 가장 많이 선택</span>
          </div>
          <h4 className="text-[14px] font-semibold text-[#09090b] mb-1.5">딜 클로징 패키지</h4>
          <p className="text-[12px] text-[#a1a1a6] leading-snug flex-1 mb-3 break-keep">협상 전략부터 금융 구조까지, 당신의 딜 메이커.</p>
      ...
      <div className="px-5 py-3 border-t border-[#e4e4e7] flex gap-3">
        ...
        <p className="text-[12px] text-[#5a5a5a] leading-snug break-keep">
